...
class ServerArgs:
    ...
    deepseek_v4_prefill_reuse: A[
        ...
        Arg(
            help=(
                "Reuse the DeepSeek V4 indexer top-K across a window of prefill "
                ...
                "lets the ten deepest C4 layers of DeepSeek-V4-Flash (24-42) share "
                "one selection per chunk. The chunk that ends a prompt is always "
                "scored in full. Only the non-paged indexer fast path is affected; "
                "other cases and the torch/flashinfer top-k backends keep the "
                "default path."
            ),
